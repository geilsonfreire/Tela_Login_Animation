...
- ⚙️ `JavaScript` para troca de estado entre login e cadastro.
...
- 🖼️ `Assets/`: armazena ícones e imagens usadas na interface e na documentação.
...
- 🎞️ O CSS reage a essa troca movendo formulários, painéis e elementos gráficos com `transform`, `transition`, `opacity` e mudança de `pointer-events`.
...
- 🅱️ `Bootstrap Icons` via `jsDelivr`.
- 🔠 `Google Fonts` para a família `Poppins`.
- ⌨️ `readme-typing-svg` para os textos animados exibidos dentro dos painéis.
...
### 1️⃣ Opção 1: execução direta

1. Clone ou baixe este repositório.
2. Acesse a pasta do projeto.
3. Abra o arquivo `index.html` no navegador.

### 2️⃣ Opção 2: servidor local recomendado
...
- 🖥️ acima de `1025px`: uso do layout desktop padrão.
...
- ✍️ textos, títulos e placeholders dos formulários;
- 🎨 cores principais e gradientes do layout;
- 🔗 ícones e botões de redes sociais;
- 🖼️ imagens dos painéis laterais;
...
- 🛡️ adicionar validação de formulário e mensagens de erro;
